...
INSERT INTO `user` (`email`,`active`,`first_name`,`last_name`,`password`,`role`)
	VALUES ('cprgsait+admin@gmail.com', true, 'Admin','Admin', 'password', 1);
INSERT INTO `user` (`email`,`active`,`first_name`,`last_name`,`password`,`role`)
	VALUES ('cprgsait+anne@gmail.com', true, 'Anne','Annerson', 'password', 2);
INSERT INTO `user` (`email`,`active`,`first_name`,`last_name`,`password`,`role`)
	VALUES ('emailtest11111111111@gmail.com', true, 'William','Lovell', 'password', 2);

INSERT INTO `note` (`Title`, `Contents`, `Owner`)
    VALUES ('Quote #1', 'Writing is nature''s way of letting you know how sloppy your thinking is.', 'cprgsait+anne@gmail.com');
INSERT INTO `note` (`Title`, `Contents`, `Owner`)
    VALUES ('Another quote', '"Java is to JavaScript as ham is to hamster." -  Jeremy Keith', 'cprgsait+anne@gmail.com');
INSERT INTO `note` (`Title`, `Contents`, `Owner`)
    VALUES ('William''s Note', 'Anne should not see this note.', 'emailtest11111111111@gmail.com');
